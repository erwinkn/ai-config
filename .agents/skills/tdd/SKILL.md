---
name: tdd
description: Fix bugs with the failing test written first. Use only when the user asks for TDD, a failing test, or a regression test, or when the bug has an obvious cheap test target.
---

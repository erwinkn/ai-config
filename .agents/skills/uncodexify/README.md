...
<p align="center">
  <img src="images/thumb.jpg" alt="Uncodexify" width="100%">
</p>
...
Uncodexify is also available as an agent skill via `SKILL.md`. This works with AI coding agents that support the skill format, including Codex and Claude Code.

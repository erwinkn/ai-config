...
Read `skills/erwin-mode/references/models.md` and use the **architect runners** row for this harness. One subagent per list entry. If a slug is missing in this session, inherit-parent (omit Task `model`).

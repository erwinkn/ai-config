...
- `model`: read `skills/erwin-mode/references/models.md`, use the **how explorer** row for this harness. If that slug is missing in this session, inherit-parent (omit Task `model`).
- `readonly`: `true`
...
- `subagent_type`: `generalPurpose`
- `model`: read `skills/erwin-mode/references/models.md`, use the **how explainer** row for this harness. If that slug is missing in this session, inherit-parent (omit Task `model`).
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per list entry. Read `skills/erwin-mode/references/models.md` and use the **how critics** row for this harness. All in a single message.

For each critic:
- `subagent_type`: `generalPurpose`
- `model`: that list entry. If a slug is missing in this session, inherit-parent (omit Task `model`). These are minimum reasoning levels. The lead should escalate any model when the architecture warrants deeper analysis.
- `readonly`: `true`

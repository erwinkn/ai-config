...
- `model`: read `skills/erwin-mode/references/models.md`, use the **why investigators** row for this harness. If that slug is missing in this session, inherit-parent (omit Task `model`).
...
- `subagent_type`: `generalPurpose`
- `model`: read `skills/erwin-mode/references/models.md`, use the **why synthesizer** row for this harness. If that slug is missing in this session, inherit-parent (omit Task `model`).

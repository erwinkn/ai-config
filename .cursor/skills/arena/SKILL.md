...
3. Pick the runners. Read `skills/erwin-mode/references/models.md` and use the **arena runners** row for this harness. One subagent per list entry. If a slug is missing in this session, inherit-parent (omit Task `model`). Spawn more when the arena covers multiple design directions. Same model N times when the work is generation-bound rather than judgment-sensitive.

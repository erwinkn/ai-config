...
The **erwin-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as erwin-mode's.
...
- The **erwin-mode** skill: example of the output shape.
